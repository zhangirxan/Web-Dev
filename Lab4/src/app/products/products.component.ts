...
export class ProductsComponent {
  ...
  constructor() {
    this.products.push(
      ...
      new Item(11, 'iPhonef', 'Brand New iPhone 16 Pro Max', 1300, 'https://resources.cdn-kaspi.kz/img/m/p/hcf/h69/87295489343518.png?format=gallery-large', 5.0, 'https://kaspi.kz/shop/p/apple-iphone-16-pro-max-256gb-chernyi-123787551/?c=750000000'),
    );
  }
